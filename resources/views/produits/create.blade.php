                    ...
                    <div class="container mx-auto">
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <form action="{{ route('produits.store') }}" method="post" class="mt-5 border-3 border-gray-800 w-full">
                                ...
                                <input type="text" name="nom" required placeholder="Ex : Jack Daniel" class="w-full py-2 px-3 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                <label for="prix" class="block text-gray-700 font-bold mt-4 mb-2">Prix du produit</label>
                                <input type="number" name="prix" required placeholder="Ex : 15000" class="w-full py-2 px-3 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                <br>
